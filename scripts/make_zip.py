...
def  main():
  ...
  installer = "\installer\InFormantMidi Installer.exe"
   
  if demo:
    installer = "\installer\InFormantMidi Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\InFormantMidi manual.pdf" 
  ]
  ...
  ZIPNAME = "InFormantMidi-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "InFormantMidi-v" + FULLVERSIONSTR + "-win-demo.zip"
