...
def main():
  ...
  plistpath = scriptpath + "/resources/InFormantMidi-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InFormantMidi-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InFormantMidi-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InFormantMidi-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InFormantMidi-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/InFormantMidi.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/InFormantMidi.iss",inplace=1):
