...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=InFormantMidi Demo Installer\n"
      else:
        line="OutputBaseFilename=InFormantMidi Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the InFormantMidi Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the InFormantMidi installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=InFormantMidi Demo installer\n"
     else:
       line="SetupWindowTitle=InFormantMidi installer\n"
